...
export default function ThemeIcon({ isDarkTheme, onThemeChange }) {
  const themeIcons = {
  ...
  return (
    <>
      ...
      <svg
        ...
        className="fill-black dark:fill-white mt-2 cursor-pointer"
      ...
      >
        <path
          id="theme-icon"
          d={isDarkTheme ? themeIcons.light : themeIcons.dark}
        ></path>
      </svg>
    </>
  );
