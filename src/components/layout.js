  ...
  return (
    <>
      ...
      <div className="flex flex-col h-screen">
        <nav className="fixed min-w-full border-b-2 border-grey-400 h-16">
          <div className="min-w-full md:w-auto min-h-full flex items-stretch mx-auto px-1 sm:px-6 lg:px-14">
            <Link href="/">
